var hljs = new function (){
            ...
            for(var A = y.firstChild; A; A = A.nextSibling){
                if(A.nodeType == 3){
                    ...
                    if(t(A) == "br"){
                        ...
                        if(A.nodeType == 1){
                            v.push({
                                event: "start", offset: z, node: A
                            });
                            z = w(A, z);
                            v.push({
                                event: "stop", offset: z, node: A
                            })
                        }
                    }
                }
    ...
    function p(z){
        ...
        if(v.second_best){
            z.second_best = {
                language: v.second_best.language, re: v.second_best.r
            }
        }
    }
    ...
    this.NM = {
        cN: "number", b: this.NR, r: 0
    };
    this.CNM = {
        cN: "number", b: this.CNR, r: 0
    };
    this.BNM = {
        cN: "number", b: this.BNR, r: 0
    };
    this.CSSNM = {
        cN: "number",
    ...
    this.TM = {
        cN: "title", b: this.IR, r: 0
    };
    this.UTM = {
        cN: "title", b: this.UIR, r: 0
    }
}();
hljs.registerLanguage("bash", function (b){
    ...
    return {
        aliases: ["sh", "zsh"], l: /-?[a-z\.]+/, k: {
            ...
            cN: "function", b: /\w[\w\d_]*\s*\(\s*\)\s*\{/, rB: true, c: [b.inherit(b.TM, {
                b: /\w[\w\d_]*/
            })], r: 0
        }, b.HCM, b.NM, d, c, a]
    }
    ...
    return {
        aliases: ["csharp"], k: a, i: /::/, c: [{
            ...
            bK: "protected public private internal", e: /[{;=]/, k: a, c: [{
                bK: "class namespace interface", starts: {
                    c: [b.TM]
                }
            }, {
...
hljs.registerLanguage("ruby", function (f){
    ...
    var h = [e, c, k, {
        cN: "class", bK: "class module", e: "$|;", i: /=/, c: [f.inherit(f.TM, {
            b: "[A-Za-z_]\\w*(::\\w+)*(\\?|\\!)?"
        }), {
            cN: "inheritance", b: "<\\s*", c: [{
                cN: "parent", b: "(" + f.IR + "::)?" + f.IR
            }]
        }, k]
    }, {
        cN: "function", bK: "def", e: " |$|;", r: 0, c: [f.inherit(f.TM, {
            b: j
        }), a, k]
    }, {
    ...
    a.c = h;
    var g = [{
        r: 1, cN: "output", b: "^\\s*=> ", e: "$", rB: true, c: [{
            cN: "status", b: "^\\s*=>"
        }, {
            b: " ", e: "$", c: h
        }]
    }, {
        r: 1, cN: "input", b: "^[^ ][^=>]*>+ ", e: "$", rB: true, c: [{
            cN: "prompt", b: "^[^ ][^=>]*>+"
        }, {
            b: " ", e: "$", c: h
        }]
    ...
    return {
        aliases: ["rb", "gemspec", "podspec", "thor", "irb"], k: i, c: g.concat(h)
    }
});
...
hljs.registerLanguage("javascript", function (a){
    return {
        aliases: ["js"], k: {
            ...
            b: "(" + a.RSR + "|\\b(case|return|throw)\\b)\\s*", k: "return throw case", c: [a.CLCM, a.CBCM, a.RM, {
                b: /</, e: />;/, r: 0, sL: "xml"
            }], r: 0
        }, {
            cN: "function", bK: "function", e: /\{/, eE: true, c: [a.inherit(a.TM, {
...
hljs.registerLanguage("xml", function (a){
    ...
    return {
        aliases: ["html", "xhtml", "rss", "atom", "xsl", "plist"], cI: true, c: [{
            ...
            cN: "tag", b: "<style(?=\\s|>|$)", e: ">", k: {
                title: "style"
            }, c: [b], starts: {
                e: "</style>", rE: true, sL: "css"
            }
        }, {
            cN: "tag", b: "<script(?=\\s|>|$)", e: ">", k: {
                title: "script"
            }, c: [b], starts: {
                e: "<\/script>", rE: true, sL: "javascript"
            }
        }, {
            b: "<%", e: "%>", sL: "vbscript"
        }, d, {
...
hljs.registerLanguage("css", function (a){
    ...
    var c = {
        cN: "function", b: b + "\\(", rB: true, eE: true, e: "\\("
    };
    return {
        cI: true, i: "[=/|']", c: [a.CBCM, {
            cN: "id", b: "\\#[A-Za-z0-9_-]+"
            ...
            cN: "rules", b: "{", e: "}", i: "[^\\s]", r: 0, c: [a.CBCM, {
                cN: "rule", b: "[^\\s]", rB: true, e: ";", eW: true, c: [{
                    cN: "attribute", b: "[A-Z\\_\\.\\-]+", e: ":", eE: true, i: "[^\\s]", starts: {
                        cN: "value", eW: true, eE: true, c: [c, a.CSSNM, a.QSM, a.ASM, a.CBCM, {
    ...
    return {
        aliases: ["jsp"], k: a, i: /<\//, c: [{
            ...
            bK: "protected public private", e: /[{;=]/, k: a, c: [{
                cN: "class", bK: "class interface", eW: true, eE: true, i: /[:"\[\]]/, c: [{
...
hljs.registerLanguage("php", function (b){
    ...
    var a = {
        cN: "preprocessor", b: /<\?(php)?|\?>/
    };
    var c = {
        cN: "string", c: [b.BE, a], v: [{
            b: 'b"', e: '"'
        }, {
            b: "b'", e: "'"
        }, b.inherit(b.ASM, {
    ...
    return {
        ...
        c: [b.CLCM, b.HCM, {
            ...
            cN: "function", bK: "function", e: /[;{]/, eE: true, i: "\\$|\\[|%", c: [b.UTM, {
                cN: "params", b: "\\(", e: "\\)", c: ["self", e, b.CBCM, c, d]
            }]
        }, {
            cN: "class", bK: "class interface", e: "{", eE: true, i: /[:\(\$"]/, c: [{
                bK: "extends implements", r: 10
            }, b.UTM]
        }, {
...
hljs.registerLanguage("actionscript", function (a){
    ...
    return {
        aliases: ["as"], k: {
            ...
            cN: "class", bK: "class interface", e: "{", eE: true, c: [{
                bK: "extends implements"
            }, a.TM]
        }, {
            cN: "preprocessor", bK: "import include", e: ";"
        }, {
            cN: "function", bK: "function", e: "[{;]", eE: true, i: "\\S", c: [a.TM, {
                cN: "params", b: "\\(", e: "\\)", c: [a.ASM, a.QSM, a.CLCM, a.CBCM, d]
            }, {
                cN: "type", b: ":", e: b, r: 10
            }]
        }]
...
hljs.registerLanguage("vbnet", function (a){
    return {
        ...
        }, i: "//|{|}|endif|gosub|variant|wend", c: [a.inherit(a.QSM, {
            c: [{
                b: '""'
            }]
        }), {
...
hljs.registerLanguage("objectivec", function (a){
    ...
    return {
        aliases: ["m", "mm", "objc", "obj-c"], k: d, l: c, i: "</", c: [a.CLCM, a.CBCM, a.CNM, a.QSM, {
            cN: "string", v: [{
                b: '@"', e: '"', i: "\\n", c: [a.BE]
            }, {
                b: "'", e: "[^\\\\]'", i: "[^\\\\][^']"
            ...
            cN: "class", b: "(" + b.split(" ").join("|") + ")\\b", e: "({|$)", eE: true, k: b, l: c, c: [a.UTM]
        }, {
...
hljs.registerLanguage("coffeescript", function (c){
    ...
    e.c = d;
    return {
        aliases: ["coffee", "cson", "iced"], k: b, c: d.concat([{
            cN: "comment", b: "###", e: "###"
        }, c.HCM, {
            cN: "function", b: "(" + a + "\\s*=\\s*)?(\\(.*\\))?\\s*\\B[-=]>", e: "[-=]>", rB: true, c: [f, {
                cN: "params", b: "\\(", rB: true, c: [{
...
hljs.registerLanguage("nginx", function (c){
    ...
    return {
        aliases: ["nginxconf"], c: [c.HCM, {
            b: c.UIR + "\\s", e: ";|{", rB: true, c: [{
                cN: "title", b: c.UIR, starts: a
            }], r: 0
        }], i: "[^\\s\\}]"
    }
});
...
hljs.registerLanguage("apache", function (a){
    ...
    return {
        aliases: ["apacheconf"], cI: true, c: [a.HCM, {
            cN: "tag", b: "</?", e: ">"
        }, {
            cN: "keyword", b: /\w+/, r: 0, k: {
...
hljs.registerLanguage("cpp", function (a){
    ...
    return {
        aliases: ["c", "h", "c++", "h++"], k: b, i: "</", c: [a.CLCM, a.CBCM, a.QSM, {
            cN: "string", b: "'\\\\?.", e: "'", i: "."
        }, {
            cN: "number", b: "\\b(\\d+(\\.\\d*)?|\\.\\d+)(u|U|l|L|ul|UL|f|F)"
        }, a.CNM, {
            cN: "preprocessor", b: "#", e: "$", k: "if else elif endif define undef warning error line pragma", c: [{
...
hljs.registerLanguage("makefile", function (a){
    ...
    return {
        aliases: ["mk", "mak"], c: [a.HCM, {
            b: /^\w+\s*\W*=/, rB: true, r: 0, starts: {
                cN: "constant", e: /\s*\W*=/, eE: true, starts: {
                    e: /$/, r: 0, c: [b]
                }
            }
        }, {
