...
(function (jQuery, window, undefined){
    ...
    var attrFn = jQuery("<input/>", {size: 1}).attr("size") && jQuery.attrFn, oldAttr = jQuery.attr, valueAttrGet = jQuery.attrHooks.value && jQuery.attrHooks.value.get || function (){
            return null;
    ...
    var matched, browser, oldInit = jQuery.fn.init, oldParseJSON = jQuery.parseJSON, rignoreText = /^[^<]*(.*?)[^>]*$/, // Note this does NOT include the #9521 XSS fix from 1.7!
        rquickExpr = /^[^<]*<[\w\W]+>[^>]*$/;
    ...
    jQuery.fn.init = function (selector, context, rootjQuery){
        ...
        if(selector && typeof selector === "string" && !jQuery.isPlainObject(context) && (match = rquickExpr.exec(selector)) && match[0]){
            ...
            if(jQuery.parseHTML){
                ...
                return oldInit.call(this, jQuery.parseHTML(match[1] || selector, context, true), context, rootjQuery);
            }
        }
