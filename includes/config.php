...
//Site Url
if(!defined('BUCKYSROOM_DOMAIN'))
	define('BUCKYSROOM_DOMAIN', $_SERVER['HTTP_HOST']);

//Site Name
if(!defined('BUCKYSROOM_SITE_NAME'))
	define('BUCKYSROOM_SITE_NAME', 'thenewboston');
...
if(!defined('BUCKYSROOM_ADMIN_EMAIL'))
	define('BUCKYSROOM_ADMIN_EMAIL', '');

//Test email)
if(!defined('BUCKYSROOM_TEST_EMAIL'))
	define('BUCKYSROOM_TEST_EMAIL', '');

//Support email
if(!defined('BUCKYSROOM_SUPPORT_EMAIL'))
	define('BUCKYSROOM_SUPPORT_EMAIL', 'support@thenewboston.com');
...
if(!defined('SESSION_NAME'))
	define('SESSION_NAME', '_BUCKYROOM_SSESSID');
...
define('BUCKYSROOM_PAYPAL_NOTIFY_URL', sprintf('https://%s/paypal_ipn_confirm.php', BUCKYSROOM_DOMAIN));
define('BUCKYSROOM_PAYPAL_RETURN_URL', sprintf('https://%s', BUCKYSROOM_DOMAIN));
define('BUCKYSROOM_PAYPAL_CANCEL_RETURN_URL', sprintf('https://%s/credits.php', BUCKYSROOM_DOMAIN));
...
define('BUCKYSROOM_BITCOIN_ADDRESS', '');
define('BUCKYSROOM_BITCOIN_GUID', '');
define('BUCKYSROOM_BITCOIN_PASSWORD', '');
...
define('TRADE_BUCKYSROOM_LISTING_FEE_RECEIVER_BITCOIN_ADDRESS', '158GY3f3mnGcNugHv6UZdGQL7ZGJp6RDRn');//Account receiving BTC (when listing items on trade section). Bitcoin address.
define('SHOP_BUCKYSROOM_LISTING_FEE_RECEIVER_BITCOIN_ADDRESS', '1FzfzJKpSrJgrp1Poch33WPgdxJoPjSFC1');//Account receiving BTC (when listing products on shop). Bitcoin address. 
