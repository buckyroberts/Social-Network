...
class PHPMailer {
    ...
    public function AddAttachment($path, $name = '', $encoding = 'base64', $type = 'application/octet-stream'){
        try{
            ...
            $this->attachment[] = [0 => $path, 1 => $filename, 2 => $name, 3 => $encoding, 4 => $type, 5 => false,  // isStringAttachment
                                   6 => 'attachment', 7 => 0];
    ...
    public function AddStringAttachment($string, $filename, $encoding = 'base64', $type = 'application/octet-stream'){
        ...
        $this->attachment[] = [0 => $string, 1 => $filename, 2 => basename($filename), 3 => $encoding, 4 => $type, 5 => true,  // isStringAttachment
                               6 => 'attachment', 7 => 0];
    }
