        ...
        <section id="main_content">
            ...
            <table cellpadding="0" cellspacing="0" class="forumlist">
                <?php if(count($topics) > 0){ ?>
                    <tfoot>
                    <tr>
                        <td colspan="3"><?php echo $pagination->renderPaginate('/forum/myposts.php?type=' . $listType . "&", count($topics)) ?></td>
                    </tr>
                    </tfoot>
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td class="icon-column">
                            <a style="float: left;" href="/forum/category.php?id=<?php echo $row['categoryID'] ?>">
                        ...
                        <td style="width:100%;" class="post-content">
                            ...
                            <a href="/forum/topic.php?id=<?php echo $row['topicID'] ?>"
                                class="postdate"><?php echo buckys_format_date($row['createdDate']); ?></a>
                            &middot;
                            <a href="/forum/topic.php?id=<?php echo $row['topicID'] ?>"
