...
<section id="main_section">
    <div class="static-page-wrap">
        ...
        <div id="question">What is <?php echo BUCKYSROOM_SITE_NAME ?>?</div>
        <p><?php echo BUCKYSROOM_SITE_NAME ?> is a social network that was built for computer programmers, web designers, and tech enthusiast. However, anyone is welcome to join.</p>
        ...
        <p>When posting a photo, select the option "Use as Profile Photo" at the bottom. Additionally, you may visit your
            <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/photo_manage.php"
        ...
        <p>Check your Spam folder. Also, some users are reporting that certain email providers (such as Yahoo!) are blocking emails from <?php echo BUCKYSROOM_SITE_NAME ?>. If you do not receive a verification email within a few hours after registration, please use a different email provider.</p>

        <div id="question">What are credits?</div>
        <p>Credits can be used to list items in the <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/trade/"
                target="_blank">Trade</a> section or the <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/shop/"
        ...
        <p>Please report bugs in the <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/forum/category.php?id=41"
        ...
        <p>Go to <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/account.php"
        ...
        <p>Bitcoin is a digital currency. You can send and receive Bitcoin with <a
                href="https://<?php echo BUCKYSROOM_DOMAIN ?>/wallet.php" target="_blank">your Bitcoin wallet</a>. </p>

        <div id="question">How do I get Bitcoin?</div>
        <p>There are many ways to get Bitcoin. You can sell items in the <a
                href="https://<?php echo BUCKYSROOM_DOMAIN ?>/shop/"
        ...
        <p>When you visit a users profile page, click the link under their profile photo that says "View Bitcoin Address". Copy that address and use it to send Bitcoin to users with
            <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/wallet.php" target="_blank">your Bitcoin wallet</a>.</p>
        ...
        <p>All users will have default ads that will appear on their <?php echo BUCKYSROOM_SITE_NAME ?> content. That means that you will earn Bitcoin every time someone views your profile, pages that you created, or forum discussions that you participated in.</p>
        ...
        <p><?php echo BUCKYSROOM_SITE_NAME ?> owner, administrators, and moderators reserve the right to cancel, delete, or disable all ads at any time. We will disable your ads if we feel that they violate the Terms of Service or otherwise inappropriate behavior. There is also an algorithm that detects and disables ads due to impression fraud caused by bots, manual refreshing, and other unauthentic behavior.</p>
        ...
        <p>
            <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/trade/"
        ...
        <p>
            <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/shop/"
        ...
        <div id="question">What items are not allowed?</div>
        <p>Please see the <a href="https://<?php echo BUCKYSROOM_DOMAIN ?>/terms_of_service.php"
